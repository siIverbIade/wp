...
<html lang="pt-BR">
	...
	<title>Acessar &lsaquo; Teste &#8212; WordPress</title>
	<meta name="robots" content="max-image-preview:large, noindex, noarchive">
<link rel="dns-prefetch" href="//s.w.org">
<link rel="stylesheet" id="dashicons-css" href="/wp-includes/css/dashicons.min.css?ver=5.9.1" media="all">
<link rel="stylesheet" id="buttons-css" href="/wp-includes/css/buttons.min.css?ver=5.9.1" media="all">
<link rel="stylesheet" id="forms-css" href="/wp-admin/css/forms.min.css?ver=5.9.1" media="all">
<link rel="stylesheet" id="l10n-css" href="/wp-admin/css/l10n.min.css?ver=5.9.1" media="all">
<link rel="stylesheet" id="login-css" href="/wp-admin/css/login.min.css?ver=5.9.1" media="all">
	...
	<script type="text/javascript">
		...
		<form name="loginform" id="loginform" action="httplocalhost/wp/wp-login.php" method="post">
			<p>
			...
			<p class="submit">
				<input type="submit" name="wp-submit" id="wp-submit" class="button button-primary button-large" value="Acessar">
									<input type="hidden" name="redirect_to" value="httplocalhost/wp/wp-admin/">
...
var _zxcvbnSettings = {"src":"httplocalhost\/wp\/wp-includes\/js\/zxcvbn.min.js"};
</script>
...
<script src="/wp-admin/js/password-strength-meter.min.js?ver=5.9.1" id="password-strength-meter-js"></script>
...
var userProfileL10n = {"user_id":"0","nonce":"ee4884fe5b"};
</script>
...
<script src="/wp-admin/js/user-profile.min.js?ver=5.9.1" id="user-profile-js"></script>
	<div class="clear"></div>
	</body>
	</html>